        ...
        <Container>
          ...
          <Grid container spacing={3} justifyContent="center">
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                <CardContent>
                  <Typography variant="subtitle1">Total Investments</Typography>
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                <CardContent>
                  <Typography variant="subtitle1">Active Startups</Typography>
                  <Typography variant="h6" sx={{ color: '#1976d2', fontWeight: 'bold' }}>
                    12
                  </Typography>
                </CardContent>
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                <CardContent>
                  <Typography variant="subtitle1">Proposals Pending</Typography>
                  <Typography variant="h6" sx={{ color: '#1976d2', fontWeight: 'bold' }}>
                    5
                  </Typography>
                </CardContent>
